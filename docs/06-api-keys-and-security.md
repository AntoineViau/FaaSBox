...
**From the editor.** Sign in, click **API keys** at the top of the left sidebar — it is there from the first visit, whether or not you have written a function yet — then fill the creation form:
